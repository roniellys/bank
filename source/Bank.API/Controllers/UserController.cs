        ...
        public async Task<IActionResult> Get(long id)
        {
            try
            {
                ...
                if(user == null)
                    return Ok(new ResultViewModel
                    {
                        Message = "Usuário encontado com sucesso",
                        Success = true,
                        Data = user
                    });
        ...
        public async Task<IActionResult> GetByEmail([FromQuery] string email)
        {
            try
            {
                ...
                if(user == null)
                    return Ok(new ResultViewModel
                    {
                        Message = "Nenhum usuário foi encontado com o email informado",
                        Success = true,
                        Data = user
                    });
        ...
        public async Task<IActionResult> GetByName([FromQuery] string name)
        {
            try
            {
                ...
                if(user == null)
                    return Ok(new ResultViewModel
                    {
                        Message = "Nenhum usuário foi encontado com o nome informado",
                        Success = true,
                        Data = user
                    });
